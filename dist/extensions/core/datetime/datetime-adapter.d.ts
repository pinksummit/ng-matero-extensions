...
export declare abstract class DatetimeAdapter<D> extends DateAdapter<D> {
    ...
    abstract createDatetime(year: number, month: number, date: number, hour: number, minute: number, seconds: number): D;
    getValidDateOrNull(obj: any): D | null;
    compareDatetime(first: D, second: D, respectMinutePart?: boolean, respectSecondPart?: boolean): number | boolean;
    ...
    sameSecond(first: D | null, second: D | null): boolean | null;
